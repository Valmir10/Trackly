...
const columns = [
  {
    ...
    color: 'bg-slate-400',
    tasks: [
      { title: 'Set up Storybook for component documentation', tag: 'Docs', tagColor: 'bg-slate-500/10 text-slate-400', priority: 'Low' as const, assignee: { initials: 'VZ', color: 'bg-rose-500/15 text-rose-400' }, dueDate: 'Jun 20', commentCount: 2 },
      { title: 'Implement dark mode toggle in settings', tag: 'Feature', tagColor: 'bg-rose-500/10 text-rose-400', priority: 'Medium' as const, assignee: { initials: 'SK', color: 'bg-blue-500/15 text-blue-400' }, dueDate: 'Jun 18', attachmentCount: 1 },
  ...
  },
  {
    ...
    color: 'bg-blue-400',
    tasks: [
      { title: 'Design dashboard layout and stat cards', tag: 'Design', tagColor: 'bg-pink-500/10 text-pink-400', priority: 'High' as const, assignee: { initials: 'VZ', color: 'bg-rose-500/15 text-rose-400' }, dueDate: 'Jun 11', dueSoon: true, commentCount: 5, attachmentCount: 3 },
  ...
  },
  {
    ...
    tasks: [
      ...
      { title: 'Refactor authentication flow components', tag: 'Frontend', tagColor: 'bg-blue-500/10 text-blue-400', priority: 'Medium' as const, assignee: { initials: 'VZ', color: 'bg-rose-500/15 text-rose-400' }, dueDate: 'Jun 12', commentCount: 3 },
    ],
  },
  {
    id: 'done',
    ...
    color: 'bg-green-400',
    tasks: [
      { title: 'Set up Vite + React + TypeScript project', tag: 'DevOps', tagColor: 'bg-orange-500/10 text-orange-400', priority: 'High' as const, assignee: { initials: 'VZ', color: 'bg-rose-500/15 text-rose-400' }, dueDate: 'Jun 1', commentCount: 2 },
