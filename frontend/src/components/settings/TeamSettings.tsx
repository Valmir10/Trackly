...
const members = [
  { name: 'Valmir Zogaj', email: 'valmir@acme.com', role: 'Owner', initials: 'VZ', color: 'bg-violet-500/15 text-violet-400', joined: 'Jun 1, 2025' },
...
const roleStyle: Record<string, string> = {
  Owner: 'border-violet-500/30 text-violet-400',
