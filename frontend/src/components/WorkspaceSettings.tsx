    ...
    <div className="flex flex-col gap-8 max-w-xl">
      ...
      <div className="flex flex-col gap-5">
        <div className="flex items-center gap-4">
          <div className="flex h-14 w-14 items-center justify-center rounded-xl bg-rose-600 text-xl font-bold text-white">
            A
          </div>
          <div>
        ...
        <Button className="w-fit bg-rose-600 hover:bg-rose-700 text-white">Save changes</Button>
      </div>
