    ...
    <section id="features" className="py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-16 text-center">
          <p className="mb-3 text-sm font-medium text-rose-400 uppercase tracking-wider">Features</p>
        ...
        <div className="grid gap-6 sm:grid-cols-2 lg:grid-cols-3">
          {features.map((feature) => {
            ...
            return (
              <div
                key={feature.title}
                className="group rounded-xl border border-border/60 bg-card p-6 hover:border-rose-500/40 hover:bg-card/80 transition-all duration-200"
              >
                <div className="mb-4 flex h-10 w-10 items-center justify-center rounded-lg bg-rose-500/10 text-rose-400 group-hover:bg-rose-500/15 transition-colors">
                  <Icon size={20} />
                </div>
