...
function KanbanPreview() {
  ...
  return (
    <div className="relative mx-auto mt-16 max-w-5xl">
      <div className="absolute inset-0 -z-10 rounded-2xl bg-rose-500/10 blur-3xl" />
  ...
  return (
    <section className="relative overflow-hidden pt-32 pb-20">
      <div className="absolute inset-0 -z-10">
        <div className="absolute left-1/2 top-0 h-[500px] w-[800px] -translate-x-1/2 rounded-full bg-rose-600/10 blur-3xl" />
      </div>
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col items-center text-center">
          ...
          <Badge
            variant="outline"
            className="mb-6 gap-1.5 border-rose-500/30 bg-rose-500/10 text-rose-400 hover:bg-rose-500/15"
          >
            <Zap size={11} />
          ...
          <div className="mt-10 flex flex-wrap items-center justify-center gap-4">
            <Link to="/register">
              <Button size="lg" className="bg-rose-600 hover:bg-rose-700 text-white gap-2 px-6">
